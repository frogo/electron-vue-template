<template lang="html">
  <div class="convention">
    ...
    <dl>
      ...
      <dt>2.使用公司仓库 https://xxxx.xxx.com/xxx/api/npm/npm-repo/</dt>
      <dd>
        如果你已经装了nrm 使用nrm add xxx https://xxx.xxx.com/xxx/api/npm/npm-repo/ <br>
        或者没装nrm 使用 npm config set registry https://xxx.xxxx.com/xxx/api/npm/npm-repo/<br>
