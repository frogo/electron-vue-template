<template lang="html">
  <div class="demo">
    <h2>请在views/demo.vue源文件中查看并参考一些常用方法，诸如http请求使用，VUEX使用，配置文件读取等</h2>
    <p>
...
export default {
  ...
  computed: {
    ...
    ...mapState([
      'userInfo' // 映射 this.user 为 store.state.user
    ]),
  ...
  mounted () {
    ...
    this.syncGetUser()
    // 读取config.js 数据
    this.$documentConfig && (this.configTitle = this.$documentConfig.title)
    // getDemo请求调用
